...
const COLUMNS: { title: string; links: FooterLink[] }[] = [
  {
    ...
    links: [
      ...
      { label: "AI Customer Service Agent", href: "/ai-agents/customer-service/" },
      { label: "AI Booking Agent", href: "/ai-agents/booking/" },
      { label: "AI Lead Qualification Agent", href: "/ai-agents/lead-qualification/" },
      { label: "AI Agent Builder", href: "/ai-agents/agent-builder/" },
  ...
  },
  {
    ...
    links: [
      ...
      { label: "SMSLocal vs Twilio", href: "/compare/smslocal-vs-twilio/" },
      { label: "SMSLocal vs Gupshup", href: "/compare/smslocal-vs-gupshup/" },
      { label: "SMSLocal vs Textlocal", href: "/compare/smslocal-vs-textlocal/" },
