...
export function HeroAnimation() {
  ...
  return (
    <div className="relative isolate mx-auto aspect-square w-full max-w-[560px] overflow-hidden">
      {/* ——— Radial glow ——— */}
      <div
        aria-hidden
      ...
      />
      <FloatingCard
        className="animate-float-slower top-[10%] right-[1%]"
      ...
      />
      <FloatingCard
        className="animate-float-slower bottom-[16%] left-[1%]"
