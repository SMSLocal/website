...
/**
 * Dark, on-brand product scenes for the AI Agents page — coded (not image
 * files) so they share one palette with the live SMSLocal inbox:
 *   • near-black background  • emerald / WhatsApp-green primary accent
 *   • multi-colour channel dots  • white / muted-grey text
 * Each scene is a self-contained dark panel meant to sit inside the page's
 * feature frames.
 */
