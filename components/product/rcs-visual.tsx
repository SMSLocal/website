...
export function RcsVisual() {
  ...
  return (
    <div className="relative">
      ...
      {/* Phone frame */}
      <div className="relative mx-auto w-[320px] overflow-hidden rounded-[40px] border border-white/10 bg-[oklch(0.14_0.02_230)] p-3 shadow-2xl shadow-black/40">
        <div className="overflow-hidden rounded-[30px] bg-white">
          ...
          {/* Conversation */}
          <div className="min-h-[360px] space-y-2.5 bg-slate-50 px-3 py-4">
            ...
            {phase === "sms-fallback" ? (
              // SMS fallback bubble
              <div className="max-w-[80%] rounded-2xl rounded-bl-sm bg-white px-3.5 py-2.5 shadow-sm ring-1 ring-black/5">
              ...
              // Rich RCS card
              <div
                className={`w-[78%] overflow-hidden rounded-2xl rounded-bl-sm bg-white shadow-sm ring-1 ring-black/5 transition ${
                  phase === "rcs-rendering" ? "opacity-60" : "opacity-100"
                }`}
              >
                {/* Rich image */}
                <div className="relative aspect-[16/9] w-full bg-gradient-to-br from-primary/90 via-primary to-accent">
                  <div className="absolute inset-0 flex items-center justify-center text-white">
                    <div className="text-center">
                      <p className="text-[9.5px] font-semibold uppercase tracking-[0.15em] opacity-75">
                        Diwali special
                      </p>
                      <p className="mt-1 font-serif text-2xl font-semibold leading-tight">
                        Flat ₹500 off
                      </p>
                      <p className="mt-0.5 text-[10px] opacity-85">orders over ₹2,499</p>
                    </div>
                  </div>
                  {phase === "rcs-rendering" && (
                ...
                {/* Suggested replies */}
                <div className="flex flex-wrap gap-1.5 border-t border-black/5 bg-slate-50/60 px-2.5 py-2">
                ...
                <p className="border-t border-black/5 px-3.5 py-1.5 text-right text-[9.5px] text-slate-400">
                  2:14 PM · RCS · Read
                </p>
              </div>
            )}
