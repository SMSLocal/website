          ...
          >
            ...
            <ul className="mt-2 space-y-1.5">
              {feed.map((row, i) => (
                <li
                  key={row.id}
                  className="flex items-center gap-2 rounded-lg border border-white/5 bg-white/[0.03] px-2.5 py-1.5 will-change-transform"
                  style={{
...
function CounterTile({
  ...
  return (
    <div className="rounded-xl border border-white/10 bg-white/[0.02] p-3">
      <div className={`inline-flex h-7 w-7 items-center justify-center rounded-lg border ${toneClass}`}>
