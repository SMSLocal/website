...
export const SEO_REGISTRY: Record<string, SeoEntry> = {
  ...
  "/products/voice": {
    ...
    description:
      "FloatChat Voice puts customer calls directly inside your support inbox — inbound and outbound calls, click-to-call, phone numbers, and full customer context in one workspace.",
