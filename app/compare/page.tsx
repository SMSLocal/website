...
const COMPARISONS = [
  ...
  },
  {
    ...
    tagIcon: Bot,
    summary: "Self-serve vs sales-led. Published INR pricing, same-day onboarding, and SMB-friendly setup.",
    focus: ["Self-serve", "INR pricing", "Fast onboarding"],
  ...
  },
  {
    ...
    tag: "Global CPaaS",
    tagIcon: Globe2,
    summary: "Right-sized for SMB to mid-market. Faster self-serve setup with an India-native AI WhatsApp agent.",
    focus: ["SMB-sized", "Self-serve", "AI agent included"],
    accent: "from-violet-500/15 to-violet-500/0",
  },
  {
    competitor: "Twixor",
    slug: "twixor",
    tag: "Agentic AI reseller",
    tagIcon: Sparkles,
    summary: "Built for the brand, not the reseller — no overhead, DID numbers in-platform, faster setup.",
    focus: ["No reseller overhead", "DID in-platform", "Self-serve"],
