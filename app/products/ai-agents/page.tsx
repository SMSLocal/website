  ...
  return (
    <>
      ...
      <main>
        ...
        {/* ── Agent use cases strip ─────────────────────────────────────── */}
        <Section tone="muted">
          <SectionHeader
            eyebrow="Explore by use case"
          ...
          <div className="mt-8 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
            ...
            >
              ...
              <div>
                ...
                <p className="mt-1 text-[13px] leading-snug text-muted-foreground">
                  Deflect repetitive tickets across every channel and escalate the rest with full context.
                </p>
              </div>
              <span className="mt-auto inline-flex items-center gap-1 text-[13px] font-semibold text-primary">
                See how it works <ArrowRight className="h-3.5 w-3.5 transition-transform group-hover:translate-x-0.5" />
              </span>
            </Link>
            ...
            >
              ...
              <div>
                ...
                <p className="mt-1 text-[13px] leading-snug text-muted-foreground">
                  Recommend products, recover carts, and guide buyers to checkout inside the conversation.
                </p>
              </div>
              <span className="mt-auto inline-flex items-center gap-1 text-[13px] font-semibold text-primary">
                See how it works <ArrowRight className="h-3.5 w-3.5 transition-transform group-hover:translate-x-0.5" />
            ...
            >
              ...
              <div>
                ...
                <p className="mt-1 text-[13px] leading-snug text-muted-foreground">
                  Schedule appointments inside the chat, check availability, and send automatic reminders.
                </p>
              </div>
              <span className="mt-auto inline-flex items-center gap-1 text-[13px] font-semibold text-primary">
                See how it works <ArrowRight className="h-3.5 w-3.5 transition-transform group-hover:translate-x-0.5" />
            ...
            >
              ...
              <div>
                ...
                <p className="mt-1 text-[13px] leading-snug text-muted-foreground">
                  Capture, qualify, score, and route hot leads to your team — synced to your CRM automatically.
                </p>
              </div>
              <span className="mt-auto inline-flex items-center gap-1 text-[13px] font-semibold text-primary">
                See how it works <ArrowRight className="h-3.5 w-3.5 transition-transform group-hover:translate-x-0.5" />
            ...
            >
              ...
              <div>
                ...
                <p className="mt-1 text-[13px] leading-snug text-muted-foreground">
                  Build, train, and launch AI agents visually — no code, no developers, no waiting.
                </p>
              </div>
              <span className="mt-auto inline-flex items-center gap-1 text-[13px] font-semibold text-primary">
                Start building <ArrowRight className="h-3.5 w-3.5 transition-transform group-hover:translate-x-0.5" />
              </span>
            </Link>
          </div>
        </Section>
