...
/** The two halves of what makes Captain AI agentic: reading live data and
 *  taking real write actions — both powered by the Composio app catalogue. */
const READ_ACTIONS = [
...
/** Composio app categories surfaced inside Captain AI's "Connect an App"
 *  directory — mirrors the 20 live categories with representative apps. */
const CATEGORIES = [
  { icon: Cpu, label: "Developer Tools & DevOps", desc: "Query repos, monitor errors, and run database lookups in-conversation.", apps: ["GitHub", "Bitbucket", "Sentry"], count: 48 },
  { icon: Users, label: "CRM", desc: "Look up and update contacts, deals, and accounts as the chat happens.", apps: ["HubSpot", "Salesforce", "Pipedrive"], count: 22 },
  { icon: CreditCard, label: "Finance & Accounting", desc: "Pull invoices, update orders, and issue payments and refunds.", apps: ["Razorpay", "Stripe", "QuickBooks"], count: 31 },
  { icon: ShoppingCart, label: "E-commerce", desc: "Fetch order status, track shipments, and process returns.", apps: ["Shopify", "WooCommerce"], count: 18 },
  { icon: Headphones, label: "Sales & Customer Support", desc: "Read and update tickets across your existing help desks.", apps: ["Zendesk", "Intercom", "Freshdesk"], count: 19 },
  { icon: Briefcase, label: "HR & Recruiting", desc: "Look up employees, leave balances, and candidate pipelines.", apps: ["Greenhouse", "BambooHR"], count: 14 },
  { icon: FileText, label: "Document & File Management", desc: "Search, read, and attach files from your storage and docs.", apps: ["Google Drive", "Notion", "Dropbox"], count: 21 },
  { icon: MessageCircle, label: "Collaboration & Communication", desc: "Read threads, post updates, and notify the right channel.", apps: ["Gmail", "Slack", "Teams"], count: 26 },
  { icon: LayoutGrid, label: "Productivity & Project Mgmt", desc: "Create tasks, move tickets, and check project status.", apps: ["Jira", "Asana", "Linear"], count: 24 },
  { icon: Calendar, label: "Scheduling & Booking", desc: "Check availability, book, and reschedule appointments.", apps: ["Google Calendar", "Calendly"], count: 11 },
  { icon: BarChart3, label: "Analytics & Data", desc: "Surface live metrics and reports without leaving the inbox.", apps: ["Google Analytics", "Mixpanel"], count: 16 },
  { icon: Database, label: "Data & Analytics", desc: "Run lookups and aggregations against your warehouse.", apps: ["Supabase", "Neon", "BigQuery"], count: 15 },
  { icon: Sparkles, label: "AI & Machine Learning", desc: "Enrich, search, and scrape the open web on demand.", apps: ["Tavily", "Firecrawl", "OpenAI"], count: 17 },
  { icon: Workflow, label: "Workflow Automation", desc: "Trigger multi-app automations as part of a resolution.", apps: ["Zapier", "Make"], count: 12 },
  { icon: Megaphone, label: "Marketing & Social Media", desc: "Manage campaigns and respond across social channels.", apps: ["Mailchimp", "Buffer"], count: 20 },
  { icon: Globe, label: "Social Media", desc: "Read mentions and publish replies across platforms.", apps: ["X", "LinkedIn", "Instagram"], count: 13 },
]
...
const PILLARS = [
  {
    icon: Plug,
    title: "Connect",
    description: "One-click OAuth to 300+ apps via Composio — Captain inherits the right scopes",
    color: "bg-primary/10 text-primary",
  },
  {
    icon: Brain,
    title: "Decide",
    description: "Reads the conversation, pulls live context, and plans which actions to run",
    color: "bg-primary/10 text-primary",
  },
  {
    icon: Zap,
    title: "Act",
    description: "Executes real app actions — update an order, issue a refund, resolve the ticket",
    color: "bg-primary/10 text-primary",
  },
]

/** Governance & helpdesk controls that wrap every Captain AI action. */
const CONTROLS = [
  ...
  return (
    <>
      ...
      <main className="overflow-x-clip">
        ...
        {/* ── HERO ──────────────────────────────────────────────────────── */}
        <section className="relative overflow-hidden bg-[oklch(0.13_0.02_230)] py-12 sm:py-16">
          {/* glow blobs */}
          <div
            aria-hidden
            className="pointer-events-none absolute -top-32 left-[20%] h-[480px] w-[480px] rounded-full opacity-20 blur-3xl"
            style={{ background: "radial-gradient(circle, color-mix(in oklch, var(--primary) 60%, transparent), transparent 70%)" }}
          />
          <div
            aria-hidden
            className="pointer-events-none absolute bottom-0 right-[5%] h-[280px] w-[280px] rounded-full opacity-10 blur-3xl"
          ...
          <div className="relative mx-auto grid max-w-7xl grid-cols-1 items-center gap-10 px-4 sm:px-6 lg:grid-cols-2 lg:gap-14">
            ...
            <div>
              ...
              <p className="mt-5 max-w-xl text-[15px] leading-relaxed text-white/60 sm:text-[16px]">
                Captain AI connects to 300+ of your business apps through Composio — CRM,
                accounting, e-commerce, file storage and more — then takes real actions inside
                every conversation. It looks up the contact, fetches the invoice, updates the
                Razorpay order, and resolves the ticket. Replies, not riddles.
              </p>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6">
            <div className="mx-auto max-w-2xl text-center">
              ...
              <p className="mt-2 text-[14px] text-muted-foreground">
                Captain AI reads live data from your connected apps and runs real write actions —
                all from inside the conversation, with no copy-paste.
              </p>
            </div>
            ...
            <div className="mt-7 grid grid-cols-1 gap-4 lg:grid-cols-2">
              ...
              <div className="group relative overflow-hidden rounded-2xl border border-border bg-card p-5 shadow-sm transition hover:shadow-md sm:p-6">
                ...
                <p className="mt-1 text-[13px] leading-relaxed text-muted-foreground">
                  Captain pulls the live record straight from the source — no stale knowledge base.
                </p>
                ...
                <div className="mt-4 flex items-center justify-between border-t border-border pt-3.5">
                  <div className="flex items-center gap-3 text-[12px] text-muted-foreground">
                    <span className="font-semibold text-foreground">&ldquo;Where&apos;s my order?&rdquo;</span> answered instantly
                  </div>
                  <a href="#apps" className="inline-flex items-center gap-1.5 text-[13px] font-semibold text-primary transition hover:gap-2.5">
                    See sources <ArrowRight className="h-3.5 w-3.5" />
                  </a>
                </div>
              </div>
              ...
              <div className="group relative overflow-hidden rounded-2xl border border-border bg-card p-5 shadow-sm transition hover:shadow-md sm:p-6">
                ...
                <p className="mt-1 text-[13px] leading-relaxed text-muted-foreground">
                  Captain runs the actual app action — update, create, refund — and closes the loop.
                </p>
                ...
                <div className="mt-4 flex items-center justify-between border-t border-border pt-3.5">
                  <div className="flex items-center gap-3 text-[12px] text-muted-foreground">
                    <span className="font-semibold text-foreground">42 actions</span> on Razorpay alone
                  </div>
                  <a href="#apps" className="inline-flex items-center gap-1.5 text-[13px] font-semibold text-primary transition hover:gap-2.5">
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6">
            <div className="mx-auto max-w-2xl text-center">
              ...
              <p className="mt-3 text-[15px] text-muted-foreground">
                300+ apps across 20 categories. Connect with one-click OAuth and Captain can look up
                contacts, invoices, orders, employees and more — and act on them directly.
              </p>
            </div>
            ...
            <div className="mt-12 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
              {CATEGORIES.map((cat) => {
                ...
                return (
                  <div
                    key={cat.label}
                    className="group flex flex-col gap-3 rounded-2xl border border-border bg-card p-5 shadow-sm transition hover:-translate-y-0.5 hover:border-primary/30 hover:shadow-md"
                  >
                    <div className="flex items-center justify-between">
                    ...
                    <div className="mt-auto flex flex-wrap gap-1.5 pt-1">
                      {cat.apps.map((app) => (
                        <span key={app} className="rounded-md border border-border bg-muted/60 px-2 py-0.5 text-[11px] font-medium text-muted-foreground">
                          {app}
                        </span>
                      ))}
                    </div>
        ...
        <section className="border-t border-border bg-background py-16 sm:py-20">
          <div className="mx-auto max-w-5xl px-4 sm:px-6">
            <div className="mx-auto max-w-2xl text-center">
              ...
              <p className="mt-3 text-[15px] text-muted-foreground">
                A rule-based bot deflects. Canned responses speed up typing. Captain AI actually
              ...
              {[
                {
                  ...
                  body: "Fetch an invoice, update a Razorpay order, change a payment link, or issue a refund — without leaving the chat.",
                  examples: ["Razorpay", "Stripe"],
                },
                {
                  icon: ShoppingCart,
                  label: "Order Support",
                  body: "Look up order status, track the shipment, and process a return the moment a customer asks.",
                  examples: ["Shopify", "WooCommerce"],
                },
                {
                  icon: Users,
                  label: "CRM & Sales",
                  body: "Find the contact, read the deal history, log a note, and update the record as the conversation moves.",
                  examples: ["HubSpot", "Salesforce"],
                },
                {
                  icon: Mail,
                  label: "Inbox & Comms",
                  body: "Triage Gmail, draft and send replies, and notify the right Slack channel on escalation.",
                  examples: ["Gmail", "Slack"],
                },
                {
                  icon: Cpu,
                  label: "Engineering & DevOps",
                  body: "Open a GitHub issue, check the latest Sentry errors, or query a Supabase table on behalf of a customer report.",
                  examples: ["GitHub", "Sentry", "Supabase"],
                },
                {
                  icon: Briefcase,
                  label: "HR & Internal",
                  body: "Answer employee questions by looking up records, leave balances, and policy docs directly.",
                  examples: ["BambooHR", "Notion"],
                },
              ].map((uc) => {
                const Icon = uc.icon
                return (
                  <div
                    key={uc.label}
                    className="flex flex-col gap-4 rounded-2xl border border-border bg-card p-6 shadow-sm transition hover:-translate-y-0.5 hover:shadow-md"
                  >
                    ...
                    <div className="mt-auto flex flex-wrap gap-1.5">
                      {uc.examples.map((ex) => (
                        <span key={ex} className="rounded-full border border-border bg-muted px-2.5 py-0.5 text-[11.5px] font-medium text-muted-foreground">
                          {ex}
                        </span>
                      ))}
                    </div>
        ...
        <section className="border-t border-border bg-muted/30 py-16 sm:py-24">
          <div className="mx-auto max-w-7xl px-4 sm:px-6">
            <div className="mx-auto max-w-2xl text-center">
              ...
              <p className="mt-3 text-[15px] text-muted-foreground">
                Captain AI runs a connect → decide → act loop on every conversation, wrapped in the
                controls your team already relies on.
              </p>
            </div>
            ...
            <div className="mt-12 grid grid-cols-1 gap-6 sm:grid-cols-3">
              {PILLARS.map((p, i) => {
                ...
                return (
                  ...
                  >
                    <span className="absolute -top-3.5 left-1/2 -translate-x-1/2 rounded-full border border-border bg-background px-3 py-0.5 text-[11px] font-bold text-muted-foreground">
                      0{i + 1}
                    </span>
            ...
            <div className="mt-12">
              <div className="mx-auto mb-6 max-w-2xl text-center">
                ...
                <p className="mt-1.5 text-[13.5px] text-muted-foreground">
                  Captain operates inside guardrails — so autonomy never means a loss of oversight.
                </p>
              </div>
            ...
            <div className="mx-auto mt-12 max-w-2xl rounded-2xl border border-primary/20 bg-primary/5 p-6 text-center">
              <p className="text-[15px] font-semibold text-foreground">
                Give Captain AI the keys to your stack
              </p>
              <p className="mt-2 text-[14px] leading-relaxed text-muted-foreground">
                Connect your first app in minutes, scope it with Custom Roles, and watch Captain
