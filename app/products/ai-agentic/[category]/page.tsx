          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6">
            ...
            <div className="mt-12 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
              {APP_CATEGORIES.map((cat) => {
                const Icon = cat.icon
                return (
                  <div key={cat.label} className="group flex flex-col gap-3 rounded-2xl border border-border bg-card p-5 shadow-sm transition hover:-translate-y-0.5 hover:border-primary/30 hover:shadow-md">
                    <div className="flex items-center justify-between">
